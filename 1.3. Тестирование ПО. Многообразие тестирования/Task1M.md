...
|Метод белого ящика и альфа-тест - у нас есть тестовая среда, тестовые юзеры и вся информация. Вид тестирования модульный - нам |нужно протестировать функционал только калькулятора.
